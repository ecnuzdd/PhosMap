...
#' ftp_url2 <- "ftp://111.198.139.72:4000/pub/PhosMap_datasets/function_demo_data/anova_result_df.RData"
...
#' writeBin(load_data2, "anova_result_df.RData")
#' load("anova_result_df.RData")
#'
